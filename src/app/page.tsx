...
import HomePageDashboard from '@/components/HomePageDashboard' // AYRILMIŞ COMPONENT'İ İÇE AKTARIYORUZ

export const revalidate = 60; // İçeriğin 60 saniyede bir güncellenmesini sağlar
