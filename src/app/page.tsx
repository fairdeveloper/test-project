...
import HomePageDashboard from '@/components/HomePageDashboard' // YENİ IMPORT
...
// Bu, ana sayfanın sunucu tarafında çalışan ana component'idir
export default async function HomePage() {
  // Analizler ve Site Ayarları verilerini sunucuda çekiyoruz
  const query = groq`{
  ...
  } = await client.fetch(query, {}, { next: { revalidate: 60 } });
